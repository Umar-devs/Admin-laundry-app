...
class ReadyToDeliverOrdersScreen extends StatefulWidget {
  const ReadyToDeliverOrdersScreen({super.key});

  @override
  State<ReadyToDeliverOrdersScreen> createState() =>
      _ReadyToDeliverOrdersScreenState();
}

class _ReadyToDeliverOrdersScreenState
    extends State<ReadyToDeliverOrdersScreen> {
                        ...
                        onTap: () {
                          Get.to(
                              DetailScreen(
                                ...
                                firstStatusTitle: 'Delivered',
                                secStatusTitle: 'Cancel',
                                firstBtnTitle: 'Delivered',
                                secBtnTitle: 'Cancel Order',
                                nextScreen: const ReadyToDeliverOrdersScreen(),
                              ),
                              duration: const Duration(milliseconds: 700),
                              transition: Transition.fadeIn);
                        },
